...
import analyticsIcon from '@public/images/home-page-24/uss.png';
import growthIcon from '@public/images/home-page-24/ai-insight.png';
import reportIcon from '@public/images/home-page-24/technical-skill-2.png';
import optimizeIcon from '@public/images/home-page-24/rank-analyzer.png';

const InternalLinksBenefits = () => {
  const t = useTranslations('InternalLinksPage.benefits');
          ...
          {benefits.map((benefit, index) => (
            <RevealAnimation key={index} delay={0.3 + index * 0.1}>
              <article className="col-span-12 md:col-span-6 p-8 rounded-[20px] bg-white dark:bg-background-6 space-y-3.5">
                ...
                <h3 className="text-heading-6 md:text-heading-5">{benefit.title}</h3>
...
export default InternalLinksBenefits;
