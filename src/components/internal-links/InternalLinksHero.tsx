...
import heroImage from '@public/images/home-page-24/internal-links-hero.png';

const InternalLinksHero = () => {
  const t = useTranslations('InternalLinksPage.hero');
...
export default InternalLinksHero;
