...
const RankAnalyzerCTA = () => {
  const t = useTranslations('RankAnalyzerPage.cta');
            ...
            <div
              ...
              <RevealAnimation delay={0.3}>
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                  ...
                  <Link href="/book-meeting" className="btn btn-outline border-white text-white hover:bg-white/10 btn-lg">
                    {t('demoButton')}
                  </Link>
                </div>
              </RevealAnimation>
...
export default RankAnalyzerCTA;
