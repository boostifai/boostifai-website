...
import rankingImage from '@public/images/about-page/ranking.png';
          ...
          <div className="lp:max-w-[1416px] xl:max-w-[1280px] lg:max-w-[1140px] max-w-[980px] mx-auto relative">
            <RevealAnimation delay={0.4} direction="left">
              <figure className="lg:max-w-[282px] sm:max-w-[200px] max-w-[120px] rounded-[20px] overflow-hidden absolute z-20 xl:left-0 xl:top-1/2 xl:-translate-y-1/2 lg:top-20 lg:left-20 -top-10 left-10">
                <Image src={rankingImage} alt="hero" className="w-full h-full object-cover block dark:hidden" />
                <Image src={rankingImage} alt="hero" className="w-full h-full object-cover hidden dark:block" />
              </figure>
            </RevealAnimation>
            ...
            <RevealAnimation delay={0.5} direction="right">
              <figure className="lg:max-w-[320px] sm:max-w-[200px] max-w-[150px] rounded-[6px] overflow-hidden absolute z-20 xl:-right-0 xl:top-1/2 xl:-translate-y-1/2 lg:right-20 lg:bottom-5 xl:bottom-auto shadow-3 sm:right-14 sm:bottom-14 right-0 bottom-0">
                ...
                <Image src={pixelImage} alt="hero" className="w-full h-full hidden dark:block" />
              </figure>
            </RevealAnimation>
          </div>
        </div>
