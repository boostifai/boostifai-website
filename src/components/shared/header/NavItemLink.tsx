...
const getVariantClasses = (variant: NavItemVariant = 'default'): string => {
  const variants = {
    ...
    light:
      'flex items-center gap-1 px-4 py-2 border border-transparent group-hover/nav:border-stroke-1 group-hover/nav:dark:border-transparent rounded-full group-hover/nav:bg-accent/20 group-hover/nav:dark:bg-secondary/20 text-tagline-1 font-normal text-white group-hover/nav:text-accent dark:text-accent/60 group-hover/nav:dark:text-accent transition-all duration-200',
  };
