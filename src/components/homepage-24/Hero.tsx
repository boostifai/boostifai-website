...
import heroBg from '@public/images/home-page-24/hero-bg.png';
...
const Hero = () => {
  ...
  return (
    <section className="relative 2xl:pt-[190px] lg:pt-[170px] md:pt-[160px] pt-[150px] pb-[100px]">
      ...
      <div className="main-container">
        ...
        <RevealAnimation delay={0.2}>
          <figure className="lp:max-w-[1240px] mx-auto w-full xl:max-w-[1140px] lg:max-w-[980px] md:max-w-[700px] sm:max-w-[600px] min-[475px]:max-w-[450px] min-[425px]:max-w-[350px] max-w-[320px]">
            <Image src={heroImage} alt="Boostifai Dashboard Preview" priority />
          </figure>
        </RevealAnimation>
      </div>
    </section>
